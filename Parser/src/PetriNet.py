...
class PetriNet:
    ...
    def from_pnml(cls, filename: str) -> "PetriNet":
        ...
        # Extract places - KHÔNG SẮP XẾP, giữ nguyên thứ tự
        place_ids = []
        place_names = []
        ...
        # Extract transitions - KHÔNG SẮP XẾP, giữ nguyên thứ tự
        trans_ids = []
        trans_names = []
        ...
        # Initialize matrices với kích thước ĐẢO NGƯỢC
        # Hàng: Transition, Cột: Place
